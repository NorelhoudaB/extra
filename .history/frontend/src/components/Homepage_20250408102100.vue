<template> 
    <div class="container text-center">
      ...
      <div class="row justify-content-center mt-4">
        <div v-for="(option, path) in options" :key="path" class="col-md-4 mb-4">
          <div class="card option-card text-center" @click="navigateTo(path)">
            <div class="card-body">
...
const options = ref({
  ...
  "/merge-files": { title: "Fusionner les fichiers", description: "Fussioner les fichiers HTML en obtient un fichiers blah blah ." }
});
