...
// Default descriptions based on route
const defaultDescriptions = {
  "/reduire": "Optimisez et compressez votre fichier pour réduire sa taille tout en maintenant la qualité.",
  "/fix-alt": "Corrigez les balises ALT manquantes dans les images pour améliorer l'accessibilité.",
  ...
  "/fix-space": "Supprimez les espaces inutiles dans le code HTML."
};

// Use prop description if provided, otherwise use default based on route
