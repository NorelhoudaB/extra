...
const defaultDescriptions = {
  ...
  "/fix-alt": "Corrigez les balises alt manquantes dans les images Erreur:XML file syntax error Element '{http://www.w3.org/1999/xhtml}img': The attribute 'alt' is required but missing",
