...
<template>
  <div class="sidebar d-flex flex-column align-items-center" :style="{ width: isCollapsed ? '60px' : '250px' }">
    <!-- Logo -->
    <div class="logo-container" @click="toggleSidebar">
      <img v-if="!isCollapsed" src=". ./assets/amelkislogomenu.png" class="logo" />
      <img v-else src=". ./assets/amelkislogo.png" class="logo" />
    </div>
