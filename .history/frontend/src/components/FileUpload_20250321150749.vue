...
const defaultDescriptions = {
  ...
  "/fix-alt": "Corrigez les balises alt manquantes dans les images. <br>Erreur: '{http://www.w3.org/1999/xhtml}img' : The attribute 'alt' is required but missing",
  "/convert-xhtml": "Convertissez votre fichier XHTML en HTML standard.",
  "/fix-table": "Corrigez les erreurs de structure dans les tableaux. <br>Erreur: '{http://www.w3.org/1999/xhtml}table': Missing child element(s)",
