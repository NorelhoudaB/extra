...
def process_images(html_file, sup_image):
    ...
    if sup_image and jpeg:
        ...
        logging.info("Suppression des images JPEG bien effectuée")
    else:
        logging.info("Suppression des images JPEG non effectuée")

    # Ensure output file is in the same directory
    output_path = html_file.parent / (html_file.stem + "_reduit.html")
