...
async def change_thead(file: UploadFile):
    ...
    processed_path = os.path.join(UPLOAD_DIR, file.filename.replace(".xhtml", "_changed.xhtml").replace(".html", "_changed.html"))
    ...
    try:
        ...
        return FileResponse(processed_path, filename=os.path.basename(processed_path), media_type="text/html")
